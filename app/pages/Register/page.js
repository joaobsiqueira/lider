...
export default function RegisterPage() {
  ...
  return (
    <section className="mt-4">
      <h1 className="text-center text-main text-4xl mb-4">Cadastre-se</h1>
      {userCreated && (
        <div className="my-4 text-center font-semibold">
          Usuario criado! Agora voce pode{" "}
          <Link href={"/login"} className="underline text-main">
            logar &raquo;
          </Link>
        </div>
      )}
      ...
      <form className="block max-w-xl mx-auto" onSubmit={handleFormSubmit}>
        ...
        <div className="mt-4 font-thin text-center">
          ...
          <Link href={"/login"} className="text-main underline font-medium">
            aqui
          </Link>
        </div>
      </form>
